...
getAdminParametersByAppname : function (appname, owner) {
// RETURN AN ARRAY OF PARAMETERS FOR THE GIVEN APPLICATION
// OWNED BY ANOTHER USER
	//console.log("Agua.Shared.getAdminParametersByAppname    plugins.core.Data.getAdminParametersByAppname(appname,)");
	...
	if ( appname == null )	return null;	
	var params = this.cloneData("adminparameters");
