...
// RETURN AN ARRAY OF STAGE PARAMETER HASHARRAYS FOR THE GIVEN STAGE
	...
	console.log("Agua.StageParameter.getStageParameters    stageObject: " + dojo.toJson(stageObject));
...
// ADD parameters ENTRIES FOR A STAGE TO stageparameters
	...
	console.log("Agua.StageParameter.addStageParametersForStage    stageObject: " + dojo.toJson(stageObject));
	...
	if ( stageObject.username == this.cookie("username") )
	{
		...
		parameters = dojo.clone(this.getAdminParametersByAppname(stageObject.name, stageObject.owner));
	}
	console.log("Agua.StageParameter.addStageParametersForStage    parameters.length: " + parameters.length);	
	console.log("Agua.StageParameter.addStageParametersForStage    BEFORE parameters: " + dojo.toJson(parameters, true));
	...
	console.log("Agua.StageParameter.addStageParametersForStage    AFTER parameters: " + dojo.toJson(parameters));
	console.log("Agua.StageParameter.addStageParametersForStage    parameters.length: " + parameters.length);
	...
	dojo.forEach(parameters, function(parameter)
	{
		console.log("Agua.StageParameter.addStageParametersForStage    Adding parameter: " + dojo.toJson(parameter));
