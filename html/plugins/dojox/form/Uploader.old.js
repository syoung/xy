dojo.provide("plugins.dojox.form.Uploader");
dojo.experimental("plugins.dojox.form.Uploader");
...
dojo.declare("plugins.dojox.form.Uploader", [dojox.form.Uploader], {
	//
	// Version: 1.6
	//
	// summary:
	...
	//		event, or use the plugins.dojox.form.uploader.FileList.
	//
	...
	templateString:'<div class="plugins.dojoxFileInput"><div dojoType="dijit.form.Button" dojoAttachPoint="button">${label}</div></div>',
	...
	onComplete: function(/* Object */customEvent){
		...
		console.log("plugins.dojox.form.Uploader.onComplete()");
	...
	getFileList: function(){
		...
		//console.log("plugins.dojox.form.Uploader.getFileList     caller: " + this.getFileList.caller.nom);
		...
		//console.log("plugins.dojox.form.Uploader.getFileList    Returning fileArray:");
...
//console.log("plugins.dojox.form.Uploader._createInput    BEFORE this.inputNode:");
//console.dir({inputNode:this.inputNode});
		...
		this.inputNode = dojo.create("input", {type:"file", name:name, className:"plugins.dojoxInputNode"}, this.domNode, "first");
...
//console.log("plugins.dojox.form.Uploader._createInput    AFTER this.inputNode:");
//console.dir({inputNode:this.inputNode});
	...
	_connectButton: function(){
		...
		this._cons.push(dojo.connect(this.inputNode, "change", this, function(evt){
			...
			//console.log("plugins.dojox.form.Uploader._connectButton    fired this.inputNode 'change'");
			//console.log("plugins.dojox.form.Uploader._connectButton    this.supports('multiple'): " + this.supports("multiple"));

			//console.log("plugins.dojox.form.Uploader._connectButton    BEFORE this.onChange, this.inputNode.files: ");
			//console.dir({files:this.inputNode.files});

			this.onChange(this.getFileList(evt));

			//console.log("plugins.dojox.form.Uploader._connectButton    AFTER this.onChange, this.inputNode.files: ");
			//console.dir({files:this.inputNode.files});
	...
	_disconnectButton: function(){
		...
		console.log("plugins.dojox.form.Uploaders._disconnectButton    this._cons:");
...
(function(){
	plugins.dojox.form.UploaderOrg = plugins.dojox.form.Uploader;
	var extensions = [plugins.dojox.form.UploaderOrg];
	plugins.dojox.form.addUploaderPlugin = function(plug){
		
		console.log("plugins.dojox.form.Uploader.addUploaderPlugin    XXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXX plug: " + plug);
		
		// summary:
		// 		Handle Uploader plugins. When the plugins.dojox.form.addUploaderPlugin() function is called,
		// 		the plugins.dojox.form.Uploader is recreated using the new plugin (mixin).
		//
		extensions.push(plug);
		dojo.declare("plugins.dojox.form.Uploader", extensions, {});
	}
})();
