...
postCreate: function() {
// RUN STARTUP
	console.log("UploadDialog.postCreate    plugins.form.Uploader.postCreate()");
	this.startup();
},
startup : function () {
	console.log("UploadDialog.startup    plugins.form.Uploader.startup()");
...
setUploader : function () {
	console.log("UploadDialog.setUploader    plugins.form.Uploader.setUploader()");
...
setPath : function (value) {
	console.log("UploadDialog.setPath     plugins.form.Uploader.setPath(value)");
