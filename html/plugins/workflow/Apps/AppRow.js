...
dojo.provide("plugins.workflow.Apps.AppRow");


dojo.declare( "plugins.workflow.Apps.AppRow",
	[ dijit._Widget, dijit._Templated ],
{
	/////}
	
//Path to the template of this widget. 
templatePath: dojo.moduleUrl("plugins", "workflow/Apps/templates/approw.html"),
