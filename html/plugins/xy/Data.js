...
////}}}}}
return declare("plugins.xy.Data", [Common], {
...
updateTable : function (table, data) {
	...
	//console.log("Data.updateTable    BEFORE Xy.updater.update(" + subscription + ")");
	if ( Xy.updater ) {
		console.log("Data.updateTable    DOING Xy.updater.update(" + subscription + ")");
		console.log("Data.updateTable    DISABLED FOR NOW");
		//Xy.updater.update(subscription, { originator : this });
	}
	//console.log("Data.updateTable    AFTER Xy.updater.update(" + subscription + ")");
