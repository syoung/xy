...
has 'outputdir'		=> ( isa => 'Str', is  => 'rw', default 	=>	''	);
has 'sources'		=> ( isa => 'Str', is  => 'rw', default 	=>	''	);
has 'mounts'		=> ( isa => 'Str', is  => 'rw', default 	=>	''	);
has 'devs'			=> ( isa => 'Str', is  => 'rw', default 	=>	''	);
...
method initialise {
	...
	$self->outputdir($self->setOutputDir()) if not $self->outputdir();
	...
	$self->setOutputFile() if not $self->outputfile();
	...
	$self->setKeyname() if not $self->keyname();
