package Xy::Common::Logger;
use Moose::Role;

=head2

ROLE        Xy::Common::Logger
...
sub fakeTermination {
	...
	#print "Xy::Common::Logger::fakeTermination    self->oldout(): ", 	$self->oldout(), "\n";
	#print "Xy::Common::Logger::fakeTermination    self->olderr(): ", 	$self->olderr(), "\n";
	#
