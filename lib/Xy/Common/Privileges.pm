...
=head2
	...
	PURPOSE
		...
		AUTHENTICATION AND ACCESS PRIVILEGE METHODS FOR Xy::Common
...
=cut
	...
	my $conf 		=	$self->conf();
	my $isAdminUsers 	= 	$conf->getKey("admins", undef);
...
sub validateGuest {
	...
	return 1 if defined $guestuser and $username eq $guestuser;
