package Illumina::WGS::Util::Dumper;
...
use Logger;
use Util;
use base qw(Object Logger Util);
...
sub dumpToSql {
	...
	#### CHECK DEFINED
	print "Illumina::WGS::Util::Dumper::dumpToSql    dumpfile not defined\n" and return if not defined $dumpfile;
	print "Illumina::WGS::Util::Dumper::dumpToSql    outputdir not defined\n" and return if not defined $outputdir;
	...
	#### GET FILE CONTENTS
	open(FILE, $dumpfile) or die "Illumina::WGS::Util::Dumper::dumpToSql    Can't open dumpfile: $dumpfile\n";
	$/ = undef;
	my $contents = <FILE>;
	close(FILE);
...
sub createDir {
	...
	print "Illumina::WGS::Util::Dumper::createDir    Can't create directory: $directory\n" and return 0 if not -d $directory;
