...
sub filterByRegex {
	...
	return $self->byRegex($files, $pattern);
}
...
=head
    ...
    PURPOSE
        ...
        FILTER ARRAY BY REGEX AND RETURN FILTERED LIST
...
sub byRegex {
	...
	return wantarray ? @$filteredlist : $filteredlist;	
}
